...
export const signUpSuccess = (user, additionalDetails) => createAction(USER_ACTION_TYPES.SING_UP_SUCCESS, { user, additionalDetails })

export const signUpFailes = (error) => createAction(USER_ACTION_TYPES.SING_UP_FAILURE, error)

export const signOutStart = () => createAction(USER_ACTION_TYPES.SIGN_OUT_START)

export const signOutSuccess = () => createAction(USER_ACTION_TYPES.SING_OUT_SUCCESS)

export const signOutFailure = (error) => createAction(USER_ACTION_TYPES.SING_OUT_FAILURE, error)