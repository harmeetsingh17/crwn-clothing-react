...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SING_UP_SUCCESS, { user: UserData, additionalDetails: AdditionalInformation }>
export type SignUpFailes = ActionWithPayload<USER_ACTION_TYPES.SING_UP_FAILURE, Error>
export type SignOutStart = Action<USER_ACTION_TYPES.SIGN_OUT_START>
export type SignOutSuccess = Action<USER_ACTION_TYPES.SING_OUT_SUCCESS>
export type SignOutFailure = ActionWithPayload<USER_ACTION_TYPES.SING_OUT_FAILURE, Error>
...
export const signUpSuccess = withMatcher((user: UserData, additionalDetails: AdditionalInformation): SignUpSuccess => createAction(USER_ACTION_TYPES.SING_UP_SUCCESS, { user, additionalDetails }))

export const signUpFailes = withMatcher((error: Error): SignUpFailes => createAction(USER_ACTION_TYPES.SING_UP_FAILURE, error))

export const signOutStart = withMatcher((): SignOutStart => createAction(USER_ACTION_TYPES.SIGN_OUT_START))

export const signOutSuccess = withMatcher((): SignOutSuccess => createAction(USER_ACTION_TYPES.SING_OUT_SUCCESS))

export const signOutFailure = withMatcher((error: Error): SignOutFailure => createAction(USER_ACTION_TYPES.SING_OUT_FAILURE, error))